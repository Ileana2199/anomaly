    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fs-5" id="exampleModalLabel">Registro de Sistema</h5>
          ...
          <form action="{{route('admin.systems.store')}}" method="POST">
           ...
           <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Sistema</label>
    ...
    <div class="card-body">
        ...
        <tbody>
            ...
            <tr>
                <td>{{$system->id}}</td>
                <td>{{$system->title}}</td>
                <td>{{$system->equipment->title}}</td>
            
                <td width="15px"> <a data-toggle="modal" data-target="#editModal{{$system->id}}" class="btn btn-info" ><i class="fas fa-edit"></i></a>
                </td>
                <div class="modal fade" id="editModal{{$system->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <form action="{{url('/admin/systems/updateModal')}}" method="POST" >
                            @csrf

                            <div class="mb-3">
                              <label for="" class="form-label">No.</label>
                              <input readonly type="text" name="id" class="form-control" id="" aria-describedby="emailHelp" value="{{$system->id}}">
                            </div>
                            
                           {{-- <div class="mb-3">
                              <label for="" class="form-label">Unidad</label>
                              <input type="text" name="unit_id" readonly class="form-control" id="" value="{{$system->unit->title}}">
                            </div> --}}


                            {{-- <div class="mb-3">
                              <label for="" class="form-label">Area</label>
                              <input type="text" name="area_id" readonly class="form-control" id="" value="{{$system->area->title}}">
                            </div> --}}
                            
                            <div class="mb-3">
                                <label for="" class="form-label">Equipo</label>
                                <input type="text" name="equipment_id" readonly class="form-control" id="" value="{{$system->equipment->title}}">
                              </div>

                            <div class="mb-3">
                              <label for="" class="form-label">Sistema</label>
                              <input type="text" name="title" required class="form-control" id="" value="{{$system->title}}">
                            </div>
                ...
                <td width="15px">
                    <form class="btn-eliminar" action="{{route('admin.systems.destroy',$system)}}" method="POST">
